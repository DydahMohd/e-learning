...
- `data/eac_academy_complete.sql` - full fresh setup: base schema plus all platform, security, assessment and session upgrades
- `data/upgrade_all_database.sql` - cumulative update for an existing `eac_academy` database
